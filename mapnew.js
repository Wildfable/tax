...
window.addEventListener("DOMContentLoaded", () => {
  ...
  var loadStates = function () {
    ...
    statesLayer.queryFeatures(query)
      .then(function (response) {
        ...
        statesLoaded = true;
        if (ageLoaded && medianLoaded && submitBtn) submitBtn.disabled = false;
      });
  ...
  var medianAgeUrl = "https://services.arcgis.com/P3ePLMYs2RVChkJx/ArcGIS/rest/services/ACS_10_14_Median_Age_Boundaries/FeatureServer/0"
